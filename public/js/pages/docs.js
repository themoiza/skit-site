	...
	content(){
		...
		return `
			<div class="flex">
				...
				<div class="col-flex-calc-220 pd2">
					...
					<hr />
					<div class="flex">
						<div class="col-flex-280px pdt2 pdb2" id="menuCheckbox">
							<div class="field">
...
&lt;/div&gt;</code></pre>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuInputColor">
							<div class="field w100p">
								<label for="input0" class="label">COLOR</label>
								<input id="input0" type="color" name="" value="#777777" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input0')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuInputDatalist">
							<div class="field w100p">
							...
							<p>
								<button onclick="ToogleDisabled('input1')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input1')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuInputDate">
							<div class="field w100p">
								<label for="input2" class="label">DATE</label>
								<input id="input2" type="date" name="" value="" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input2')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input2')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuInputDateLocal">
							<div class="field w100p">
								<label for="input3" class="label">DATE LOCAL</label>
								<input id="input3" type="datetime-local" name="" value="" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input3')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input3')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuInputEmail">
							<div class="field w100p">
								<label for="input4" class="label">E-MAIL</label>
								<input id="input4" type="email" name="" value="" placeholder="e-mail" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input4')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input4')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuInputFile">
							<div class="field w100p">
								<label for="input5" class="label">FILE</label>
								<input id="input5" type="file" name="" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input5')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<div class="col-flex-280px pdt2 pdb2" id="menuInputMonth">
							<div class="field w100p">
								<label for="input6" class="label">MONTH</label>
								<input id="input6" type="month" name="" value="" placeholder="2023-01" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input6')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input6')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<div class="col-flex-280px pdt2 pdb2" id="menuInputNumber">
							<div class="field w100p">
								<label for="input7" class="label">NUMBER</label>
								<input id="input7" type="number" name="" value="" step="0.01" placeholder="0.01" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input7')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input7')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<div class="col-flex-280px pdt2 pdb2" id="menuInputPassword">
							<div class="field w100p">
								<label for="input8" class="label">PASSWORD</label>
								<input id="input8" type="password" name="" value="" placeholder="password" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input8')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input8')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuInputRadio">
							<div class="field">
...
&lt;/div&gt;</code></pre>
						...
						<div class="col-flex-280px pdt2 pdb2" id="menuInputRange">
							<div class="field w100p">
							...
							<p>
								<button onclick="ToogleDisabled('input9')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuDualRange">
							<div class="field w100p">
							...
							<p>
								<button onclick="Dualrange.toggleDisabled('dualrange1')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<div class="col-flex-280px pdt2 pdb2" id="menuInputSearch">
							<div class="field w100p">
								<label for="input10" class="label">SEARCH</label>
								<input id="input10" type="search" name="" value="" placeholder="search" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input10')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input10')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<div class="col-flex-280px pdt2 pdb2" id="menuInputSelect">
							<div class="field w100p">
							...
							<p>
								<button onclick="ToogleDisabled('select1')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuInputTel">
							<div class="field w100p">
								<label for="input11" class="label">TEL</label>
								<input id="input11" type="tel" name="" value="" placeholder="tel" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input11')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input11')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuInputText">
							<div class="field w100p">
								<label for="input12" class="label">TEXT</label>
								<input id="input12" type="text" name="" value="" placeholder="text" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input12')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input12')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<div class="col-flex-280px pdt2 pdb2" id="menuInputTextarea">
							<div class="field w100p">
								<label for="input13" class="label">TEXTAREA</label>
								<textarea id="input13" name="" placeholder="textarea"></textarea>
							</div>
							<p>
								<button onclick="ToogleDisabled('input13')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input13')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<div class="col-flex-280px pdt2 pdb2" id="menuInputTime">
							<div class="field w100p">
								<label for="input14" class="label">TIME</label>
								<input id="input14" type="time" name="" value="" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input14')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input14')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<div class="col-flex-280px pdt2 pdb2" id="menuInputUrl">
							<div class="field w100p">
								<label for="input15" class="label">URL</label>
								<input id="input15" type="url" name="" value="" placeholder="url" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input15')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input15')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
						...
						<div class="col-flex-280px pdt2 pdb2" id="menuInputWeek">
							<div class="field w100p">
								<label for="input16" class="label">WEEK</label>
								<input id="input16" type="week" name="" value="2023-W01" />
							</div>
							<p>
								<button onclick="ToogleDisabled('input16')" class="btn btn-trans" data-title="Toggle Disabled" data-title-position="right">TG DISABLED</button> 
								<button onclick="TooglerReadonly('input16')" class="btn btn-trans" data-title="Toggle Readonly" data-title-position="right">TG READONLY</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
...
&lt;/div&gt;</code></pre>
					...
					<hr />
					<h2>NOT STANDARD</h2>
					<div class="margin-fix pdt2 pdb2" id="menuInfo">
						<p><b>Info</b></p>
						<div class="Info w100p">Info</div>
						<div class="Info Info-pri">Info pri</div>
						<div class="Info Info-sec">Info sec</div>
						<div class="Info Info-warning">Info warning</div>
						<div class="Info Info-danger">Info Danger</div>
					</div>
					<hr class="col-flex" />
					<div class="flex">
						<div class="col-flex-280px pdt2 pdb2" id="menuCompToggle">
...
&lt;/div&gt;</code></pre>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuCompToggle2">
					...
					<h2>JS COMPONENTS</h2>
					<div class="flex">
						<div class="col-flex-280px pdt2 pdb2" id="menuJsConfirm">
							...
							<p>
								<button onclick="Confirm({
									...
									'ok': 'YES',
									'no': 'NO',
									'okclass': 'btn btn-danger btn-med',
									'noclass': 'btn btn-light btn-med',
									'okFn': () => {console.log('ok')},
									'noFn': () => {console.log('no')},
									'cancelFn': () => {console.log('ignore')}
								});" class="btn btn-danger"><i class="fi fi-rs-trash"></i> DELETE</button>
							</p>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
						</div>
						...
						<div class="col-flex-280px pdt2 pdb2" id="menuJsCopy">
...
&lt;button&nbsp;onclick=&quot;Copy.id(&#39;id&#39;)&quot;&gt;copy&lt;/button&gt;</code></pre>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuJsDebounce">
							<p class="mgb2"><b>Debounce</b></p>
							<p><button class="btn btn-pri" onclick="Debounce(() => {
						...
						<hr class="col-flex" />
						<div class="col-flex pdt2 pdb2" id="menuJsTab">
							<p class="mgb2"><b>Tab</b></p>
							<div class="Tabs">
								<div id="tabs"></div>
								<div class="Tabs-area" id="area1">
									<div data-tab="tab1">
										<div class="pd1">
											<table>
												<thead>
													<tr>
														<th class="tx-left">COL 1 <i class="fi fi-rs-arrows-alt-v"></i></th>
														<th class="tx-left">COL 2 <i class="fi fi-rs-arrows-alt-v"></i></th>
														<th class="tx-left">COL 3 <i class="fi fi-rs-arrows-alt-v"></i></th>
														<th class="tx-left">COL 4 <i class="fi fi-rs-arrows-alt-v"></i></th>
													</tr>
												</thead>
												<tbody>
													<tr>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuJsTooltip">
...
&lt;/div&gt;</code></pre>
						...
						<hr class="col-flex" />
						<div class="col-flex-280px pdt2 pdb2" id="menuJsWarning">
							<p class="mgb2"><b>Warning</b></p>
							<button class="btn btn-light mgb1" onclick="Warning({'title': 'title','message': 'Exorcizamus te, omnis immundus spiritus, omnis satanica potestas, omnis incursio infernalis adversarii, omnis legio, omnis congregatio et secta diabolica... Ergo, draco maledicte et omnis legio diabolica, adjuramus te ... cessa decipere humanas creaturas, eisque æternæ perditionìs venenum propinare...', 'timeout': 100000, 'position': 9});">OPEN</button>
							<button class="btn btn-light mgb1" onclick="Warning({'color': 'danger', 'title': 'title','message': 'Danger', 'timeout': 10000, 'id': 'danger'});">OPEN DANGER</button>
							<button class="btn btn-light mgb1" onclick="Warning({'color': 'pri', 'title': 'title','message': 'Pri', 'timeout': 10000, 'id': 'pri'});">OPEN PRIMARY</button>
							<button class="btn btn-light mgb1" onclick="Warning({'color': 'sec', 'title': 'title','message': 'Sec', 'timeout': 3000, 'id': 'sec'});">OPEN SECONDARY</button>
							<button class="btn btn-light mgb1" onclick="Warning({'color': 'dark', 'title': 'title','message': 'Dark', 'timeout': 10000, 'id': 'dark'});">OPEN DARK</button>
							<button class="btn btn-light mgb1" onclick="Warning({'color': 'light', 'title': 'title','message': 'Light', 'timeout': 10000, 'id': 'light'});">OPEN LIGHT</button>
						</div>
						<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
							xx
						</div>
					...
					<hr class="col-flex" />
					<div class="col-flex-280px pdt2 pdb2" id="menuButtons">
						<div>
						...
						<div>
							<button class="btn btn-pri mgb1">PRIMARY</button> 
							<button class="btn btn-pri mgb1" disabled="disabled">PRIMARY DISABLED</button>
						</div>
						<div>
							<button class="btn btn-sec mgb1">SECONDARY</button> 
							<button class="btn btn-sec mgb1" disabled="disabled">SECONDARY DISABLED</button>
						</div>
						<div>
							<button class="btn btn-danger mgb1">DANGER</button> 
							<button class="btn btn-danger mgb1" disabled="disabled">DANGER DISABLED</button>
						</div>
						<div>
							<button class="btn btn-dark mgb1">DARK</button> 
							<button class="btn btn-dark mgb1" disabled="disabled">DARK DISABLED</button>
						</div>
						<div>
							<button class="btn btn-light mgb1">LIGHT</button> 
							<button class="btn btn-light mgb1" disabled="disabled">LIGHT DISABLED</button>
						</div>
						<div>
							<button class="btn btn-trans">TRANSPARENT</button>
							<button class="btn btn-trans mgb1" disabled="disabled">TRANSPARENT DISABLED</button> 
						</div>
					</div>
					<div class="col-flex-calc-280 pdt2 pdb2 pdl2">
					</div>
