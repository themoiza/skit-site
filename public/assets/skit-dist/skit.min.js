...
window.LockScreen={mask:'<span class="LockScreenSpinner"></span>Wait a moment',timeout:6e4,blur:!1,lock:e=>{var n;(e&&(e.timeout&&(LockScreen.timeout=e.timeout),e.title&&(LockScreen.mask='<span class="LockScreenSpinner"></span>'+e.title),e.blur&&1==e.blur&&(LockScreen.blur=!0)),document.getElementById("IdLockScreen"))?(n=document.getElementById("IdLockScreen")).innerHTML=LockScreen.mask:((n=document.createElement("dialog")).setAttribute("id","IdLockScreen"),n.innerHTML=LockScreen.mask,document.body.appendChild(n));document.getElementById("IdLockScreen").style="animation-duration: "+LockScreen.timeout+"ms",e.blur&&(document.body.style.filter="blur(3px)"),document.getElementById("IdLockScreen").showModal(),Debounce((()=>{LockScreen.unlock()}),LockScreen.timeout,"IdLockScreen")},unlock:()=>{document.getElementById("IdLockScreen").close(),document.body.style.filter=null}};
