...
class Superselect{constructor(t){this.lastEvent="none",document.getElementById(t)&&(this.comp=document.getElementById(t),this.label=this.comp.querySelector(".SuperSelectLabel"),this.label.addEventListener("click",(t=>{"click"==this.lastEvent&&(this.comp.blur(),this.lastEvent="blur"),this.lastEvent="click"})),this.comp.addEventListener("focus",(t=>{this.lastEvent="focus"})),this.comp.addEventListener("focusin",(t=>{this.lastEvent="focusin"})))}}
