...
class Pagination{constructor(t){this.currentPage=1,this.byPage=100,this.totalData=317960,this.totalPages=Number((this.totalData/this.byPage).toFixed(0)),this.comp=[],this.left=[],this.right=[],this.all=[],this.fn=!1,t.forEach(((t,e)=>{document.getElementById(t)&&(this.comp[e]=document.getElementById(t),this.comp[e].querySelector(".PagLeft")&&(this.left[e]=this.comp[e].querySelector(".PagLeft")),this.comp[e].querySelector(".PagAll")&&(this.all[e]=this.comp[e].querySelector(".PagAll")),this.comp[e].querySelector(".PagRight")&&(this.right[e]=this.comp[e].querySelector(".PagRight"))),this.left[e]&&this.left[e].addEventListener("click",(t=>{t.ctrlKey&&t.shiftKey?this.previous(1e3):t.ctrlKey?this.previous(100):t.shiftKey?this.previous(10):this.previous(1)})),this.right[e]&&this.right[e].addEventListener("click",(t=>{t.ctrlKey&&t.shiftKey?this.next(1e3):t.ctrlKey?this.next(100):t.shiftKey?this.next(10):this.next(1)})),this.all[e]&&this.all[e].addEventListener("click",(t=>{console.log("all")}))})),this.setPage(1)}setCallBack(t){this.fn=t}previous(t){this.currentPage-t>=1&&(this.currentPage=Number(this.currentPage)-t),this.setPage(this.currentPage)}next(t){this.currentPage+t<=this.totalPages&&(this.currentPage=Number(this.currentPage)+t),this.setPage(this.currentPage)}setPage(t){this.all.forEach(((t,e)=>{this.all[e].textContent=this.currentPage+" de "+this.totalPages+", "+this.totalData})),this.fn&&"function"==typeof this.fn&&Debounce((()=>{(0,this.fn)()}),200,"pagination")}setTotal(t){this.totalData=Number(t),this.totalPages=Number((this.totalData/this.byPage).toFixed(0)),this.setPage(this.currentPage)}getByPage(){return this.byPage}getPage(){return this.currentPage}}
