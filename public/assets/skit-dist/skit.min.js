...
class Modal{constructor(t){this.currentX=0,this.currentY=0,this.lastX=0,this.lastY=0,this.mouseX=0,this.mouseY=0,this.canMove=!1,this.comp=document.getElementById(t),this.move=this.comp.querySelector(".Move"),this.initMove(),this.comp.addEventListener("click",(()=>{this.setFocus()}))}setCenter(){var t=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth,e=window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight,s=this.comp.getBoundingClientRect();this.currentX=t/2-s.width/2,this.currentY=e/2-s.height/2,this.lastX=this.currentX,this.lastY=this.currentY,this.comp.style.left=this.currentX+"px",this.comp.style.top=this.currentY+"px"}initMove(){document.addEventListener("mousedown",(t=>{t.target==this.move&&(this._setZIndex(this._getZIndex()),this.canMove=!0,this.mouseX=t.x,this.mouseY=t.y,this.currentX=this.lastX,this.currentY=this.lastY,this.currentX=Number(this.comp.style.left.replace("px","")),this.currentY=Number(this.comp.style.top.replace("px","")),document.addEventListener("mousemove",this.handleMove))})),document.addEventListener("mouseup",(t=>{this.canMove=!1,document.removeEventListener("mousemove",this.handleMove)}))}handleMove=t=>{!0===this.canMove&&window.requestAnimationFrame((()=>{this.lastX=(this.currentX+t.x-this.mouseX).toFixed(0),this.lastY=(this.currentY+t.y-this.mouseY).toFixed(0),this.comp.style.left=this.lastX+"px",this.comp.style.top=this.lastY+"px"}))};_getZIndex(){var t=document.querySelectorAll("dialog"),e=0;return t.forEach((t=>{if(this.comp!=t){var s=Number(window.document.defaultView.getComputedStyle(t).getPropertyValue("z-index"));s>=e&&(e=s)}})),e<=99&&(e=99),++e}_setZIndex(t){this.comp.style.zIndex=t}setTitle(t){this.title=t.substring(0,50),this.comp.querySelector(".Move").textContent=this.title}setContent(t){this.comp.querySelector(".ModalContent").innerHTML=t}setFocus(){this._setZIndex(this._getZIndex())}open(){this.comp.show(),this._setZIndex(this._getZIndex()),this.setCenter()}close(){this.comp.close(),this.currentX=0,this.currentY=0,this.comp.style.transform=null,this.comp.style.zIndex=null}}
